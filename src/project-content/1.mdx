{/* src/project-content/your-qgis-plugin-id.mdx */}
...
![Main Plugin Interface](path/to/screenshot-main-dialog.png)
*Caption: The main dialog window of the [Plugin Name] plugin.*
